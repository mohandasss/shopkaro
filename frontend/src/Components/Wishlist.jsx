...
const Wishlist = () => {
  ...
  return (
    <section className="py-24 2xl:py-44 bg-blueGray-100">
      <div className="container px-4 mx-auto">
        ...
        {wishdata.length < 1 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {wishdata.map((item) => (
              <Link to={`/products/${item._id}`} state={item} key={item._id}>
                  ...
                  <div className="p-6 relative">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        handleRemove(item._id); // Corrected to use item._id
                      }}
                    >
                      Remove
                    </button>
      ...
      <Popup message="Item removed from wishlist!" isVisible={isPopupVisible} />
    </section>
  );
