...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
  key={product.id}
  className="w-full sm:w-1/2 lg:w-1/5 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full"
>
  ...
  <div className="px-5 pb-5 flex flex-col justify-between flex-grow">
    ...
    <div className="flex items-center justify-between">
      ...
      {/* Only show "Add to cart" if the name is not too long */}
      {product.name && (
        <a
          href="#"
